...
author: "Joseph Holler, Junyi Zhou, Peter Kedron, Drew An-Pham, Derrick Burt, Audrey Park"
date: "`r Sys.Date()`"
output: pdf_document
editor_options:
  markdown:
...
Version 2.1 \| First Created July 7, 2021 \| Updated September 23, 2023
...
tm_disability_rates
```
```{r map-over75-rates, message = FALSE}
tm_over75 <- tm_shape(acs_covid) +
  tm_polygons("pct_75",
    title = "Percent of People over 75\n(ACS 2014-2018)",
    style = "quantile",
    border.alpha = .2,
    lwd = 0.2,
    palette = "Oranges"
...
```{r map-65to74-rates, message = FALSE}
tm_65to74 <- tm_shape(acs_covid) +
  tm_polygons("pct_65_74",
    title = "Percent of People Ages 65 to 74\n(ACS 2014-2018)",
    style = "quantile",
    border.alpha = .2,
    lwd = 0.2,
    palette = "Oranges"
...
tm_65to74
```
```{r map-5to17-rates, message = FALSE}
tm_5to17 <- tm_shape(acs_covid) +
  tm_polygons("pct_5_17",
    title = "Percent of People Ages 5 to 17\n(ACS 2014-2018)",
    style = "quantile",
    border.alpha = .2,
    lwd = 0.2,
    palette = "Oranges"
...
This reproduction attempt unveiled the value of reproducing studies in order to uncover shortcomings in study design and analysis. Because of the misrepresented COVID hotspots due to the way the original authors carried out the clustering analysis, this study highlighted the importance of looking at visualizations with a critical eye. In future studies, I would look toward visualizations of the data in order to uncover analyses that went awry. The reproduction study was successful in matching many of the results, providing context with visualizations, identifying missing data, conducting correlation analyses, and calculating cluster risk so as not to misaccurately represent epicenters. The impact of this study is diminished because of its clustering methods, but its research is nevertheless important in helping inform future studies of synergistic effects of two variables, such as the impact that demographic factors have on disability, and how disability impacts COVID cases.
